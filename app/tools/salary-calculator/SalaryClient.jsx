    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-gray-100 px-4 py-10">
      <div className="max-w-6xl mx-auto">
        ...
        <h1 className="text-4xl font-bold text-center mb-4">
          Salary After Tax Calculator USA (Take Home Pay Estimator)
        </h1>

        {/* INTRO */}
        <p className="text-center text-gray-600 max-w-2xl mx-auto mb-8">
          Use this free salary calculator to estimate your take-home pay in the
          USA after federal and state taxes. Adjust your salary, state, and
          filing status to get accurate results instantly.
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-6 rounded-2xl shadow">
            ...
            <p className="text-xs text-gray-500 mt-4">
              This is an estimate based on simplified US tax rules.
            </p>
          </div>
        </div>
